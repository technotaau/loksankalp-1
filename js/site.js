...
(function () {
  ...
  /* "राजस्थान के जिले : 43" पढ़कर लगता था कि राजस्थान में 43 जिले हैं।
     ...
     41 कहीं लिखा नहीं गया है, वह जिले के ड्रॉपडाउन से गिना जाता है। यानी
     जिस दिन tools/districts.txt बदलेगी और ड्रॉपडाउन नया बनेगा, यह संख्या
     अपने आप बदल जाएगी। ड्रॉपडाउन न मिले तो लेबल जैसा है वैसा रह जाता है। */
  (function () {
    var label = document.querySelector('[data-jile-label]');
    var jila = document.getElementById('i-jila');
    if (!label || !jila) return;
    var kul = 0;
    Array.prototype.forEach.call(jila.options, function (o) {
      if (o.value && o.value.trim()) kul++;          // "जिला चुनें" नहीं गिना जाता
    });
    // "में से" के बीच अटूट space, वरना 390px पर "से" अकेला अगली पंक्ति में
    // चला जाता है। आसपास "अन्य राज्य" और "अन्य देश" लिखा है, इसलिए यहाँ
    // राजस्थान दोहराने की ज़रूरत नहीं।
    if (kul > 1) label.textContent = kul + ' जिलों में\u00a0से';
  }());

  /* कौन-सा पता खोजा और नहीं मिला।

     GA4 में "पृष्ठ नहीं मिला" के दर्शन तो दिखते हैं, पर वह नहीं दिखता कि
     आदमी किस पते पर गया था। उसके बिना यह अंदाज़ा लगाने के सिवा कुछ नहीं
     बचता कि कहाँ से आ रहे हैं, और अंदाज़े से बग नहीं पकड़े जाते।

     इसलिए 404 वाला पन्ना खुलते ही वह पता भेज देता है जो नहीं मिला, और यह
     भी कि आदमी किस कड़ी से आया। दोनों में कोई निजी जानकारी नहीं है। */
  (function () {
    if (!document.querySelector('[data-404]')) return;
    track('panna_nahi_mila', {
      khoja_gaya: (location.pathname + location.search).slice(0, 100),
      kahan_se: (document.referrer || '(सीधे)').slice(0, 100)
    });
  }());
